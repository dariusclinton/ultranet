...
class User extends BaseUser implements UserInterface {
   ...
   /* public function setEmail($email) {
     ...
     * Set image
     *
     * @param \Ultranet\UserBundle\Entity\ImageUser $image
     *
     * @return User
     */
    public function setImage(\Ultranet\UserBundle\Entity\ImageUser $image = null)
    {
        $this->image = $image;
     ...
     * Get image
     *
     * @return \Ultranet\UserBundle\Entity\ImageUser
     */
